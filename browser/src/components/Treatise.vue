<template>
    <div style="padding: 30px">
        ...
        <!--展示数据-->
        <el-dialog title="论著条目" @close="jobData = []" v-model="dialogVisible" width="90%">
        ...
        <!--add-->
        <el-dialog title="添加论著条目" v-model="dialogVisibleAdd" width="50%" :before-close="handleClose">
            <el-form :model="form" :rules="rules">
                ...
                <el-form-item label="发表年月" prop="employingUnit">
                    <el-date-picker type="date" placeholder="选择日期" v-model="form.data" style="width: 50%;"></el-date-picker>
                </el-form-item>
        ...
        <!--编辑-->
        <el-dialog title="编辑论著条目" v-model="dialogVisibleEdit" width="50%" :before-close="handleClose">
            <el-form :model="form" :rules="rules">
                <el-form-item label="论著名称" prop="reviewUnit">
                    <el-input v-model="form.name" style="width: 80%"></el-input>
                </el-form-item>
